...
function getProductBadge(product) {
    if (isMostViewed(product)) return '<div class="p-tag hot">الأكثر مبيعا</div>';
...
// HTML inline handler (index.html uses oninput="onSearchInput()")
...
function refreshCurrentProductLists() {
    ...
    renderProds(list);
    renderWorks();
    if (window._view === 'trending') renderTrending();
}