...
class AuthManager {
    ...
    async verifyCredentials(username, password) {
        try {
            const response = await fetch('https://script.google.com/macros/s/AKfycbz0rYdQkY3MyaYw3Af7TYAEk0I9_eLNzhWf2Wdrzh-ryYwom1Ro_NcvsT1C3zAssnseZw/exec', {
                method: 'POST',
                headers: {
    ...
    logActivity(action, details = {}) {
        try {
            ...
            // إرسال إلى الخادم
            fetch('https://script.google.com/macros/s/AKfycbz0rYdQkY3MyaYw3Af7TYAEk0I9_eLNzhWf2Wdrzh-ryYwom1Ro_NcvsT1C3zAssnseZw/exec', {
                method: 'POST',
